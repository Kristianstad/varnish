...
* VAR_SUBS: semicolon-separated (;) list of sub names.
* VAR_&lt;sub&gt;: #-separated list of sub definition rows for &lt;sub&gt;. F ex VAR_VCL_RECV='set req.http.Host = regsub(req.http.Host, ":[0-9]+", "");# return (pass);'.
